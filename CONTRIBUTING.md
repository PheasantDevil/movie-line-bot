...
映画情報 LINE Bot へのコントリビューションを歓迎します！
...
- [コミットメッセージ](#コミットメッセージ)
- [Pull Request の提出](#pull-requestの提出)
- [質問とサポート](#質問とサポート)
...
バグを見つけた場合は、GitHub の Issue で報告してください。
...
新機能の提案も GitHub の Issue で受け付けています。
...
1. **自動チェック**: GitHub Actions が自動的に実行
...
2. [ドキュメント](docs/)を確認
3. [既存の Issue](https://github.com/your-username/movie-line-bot/issues)を検索

### 質問方法

質問は GitHub の Issue で受け付けています。
...
このプロジェクトに貢献することにより、あなたの貢献が MIT ライセンスの下でライセンスされることに同意したものとみなされます。
